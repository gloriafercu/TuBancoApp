...
public class ProbarCuenta {
    public static void main(String[] args) {
        ...
        // Modifico el valor del dni del cliente con el setter
        ...
        // Modifico el valor de la comisión con el setter
        System.out.println("La comisión del cliente cuentaNomina cn2 después: " + cn2.getComision());
        cn2.setComision(10000);
        // Obtengo el nuevo valor de la comisión con el getter y después el nuevo saldo de la cuenta
